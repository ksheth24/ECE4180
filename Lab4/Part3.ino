...
int* PCR_TIMERGROUP0_CONF_REG = (int*) 0x6009603C;
int* PCR_TIMERGROUP0_WDT_CLK_CONF_REG = (int*) 0x60096040;

int* TIMG_T0CONFIG_REG  = (int*) 0x60008000;
int* TIMG_T0LO_REG      = (int*) 0x60008004;
int* TIMG_T0HI_REG      = (int*) 0x60008008;
int* TIMG_T0UPDATE_REG  = (int*) 0x6000800C;
int* TIMG_T0ALARMLO_REG = (int*) 0x60008010;
int* TIMG_T0ALARMHI_REG = (int*) 0x60008014;
int* TIMG_T0LOADLO_REG  = (int*) 0x60008018;
int* TIMG_T0LOADHI_REG  = (int*) 0x6000801C;
int* TIMG_T0LOAD_REG    = (int*) 0x60008020;
...
void setup() {
    ...
    // Enabling XTAL clk
    *PCR_TIMERGROUP0_WDT_CLK_CONF_REG |= (1 << 22);
